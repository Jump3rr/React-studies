        ...
        <Wrapper2>
            ...
            <WorkingElement>
                <OneElement>
                    ...
                    <div>Take a few minutes to look at the most importnant elements and specificities of your entities.</div>
                </OneElement>
                <OneElement>
                    <StyledImg src="./media/icons/structure.svg" alt='' />
                    <h3>Structure the ownership</h3>
                    <div>Get a clear view of the ownership by looking at the relations between individuals and entities.</div>
                </OneElement>
                <OneElement>
                    <StyledImg src="./media/icons/calendar.svg" alt='' />
                    <h3>Define the calendar</h3>
                    <div>Prepare future events by creating detailed plans around the life of your entity.</div>
                </OneElement>
            </WorkingElement>
            :<div></div>
            }
