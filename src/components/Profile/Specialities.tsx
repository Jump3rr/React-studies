      ...
      <div>
        <About>
          <OneRow>
            ...
            {!props.isInEditMode ? (
              <div>
                <SelectedOption>{info.expertise}</SelectedOption>
              </div>
            ) : (
              <select
                onChange={(e) =>
                  setInfo({ ...info, expertise: e.target.value })
                }
              >
          ...
          <OneRow>
            ...
            {!props.isInEditMode ? (
              ...
              <div>
                <select
                  onChange={(e) =>
                    setInfo({ ...info, specialities1: e.target.value })
                  }
                >
                  <option value="Example option 1">Example option 1</option>
                  <option value="Example option 2">Example option 2</option>
                ...
                <select
                  onChange={(e) =>
                    setInfo({ ...info, specialities2: e.target.value })
                  }
                >
                  <option value="Example option 1">Example option 1</option>
                  <option value="Example option 2">Example option 2</option>
                  <option value="Example option 3">Example option 3</option>
                  <option value="Transaction over 500M€/$">
          ...
          <OneRow>
            ...
            {!props.isInEditMode ? (
              ...
              <div>
                <select
                  onChange={(e) =>
                    setInfo({ ...info, admission1: e.target.value })
                  }
                >
                  <option value="Example option 1">Example option 1</option>
                  <option value="Example option 2">Example option 2</option>
                  <option value="Example option 3">Example option 3</option>
                  <option value="Paris bar association">
                    Paris bar association
                  </option>
                </select>
                <select
                  onChange={(e) =>
                    setInfo({ ...info, admission2: e.target.value })
                  }
                >
                  <option value="Example option 1">Example option 1</option>
                  <option value="Example option 2">Example option 2</option>
          ...
          <OneRow>
            ...
            {!props.isInEditMode ? (
              <div>
                <SelectedOption>{info.counties}</SelectedOption>
              </div>
            ) : (
              <select
                onChange={(e) => setInfo({ ...info, counties: e.target.value })}
              >
                <option value="Example option 1">Example option 1</option>
                <option value="Example option 2">Example option 2</option>
                <option value="Example option 3">Example option 3</option>
